 ...
 *
 * Test Class for Main Controller of Task Module
 *
 * @category Test
 * @package Task
...
namespace OnePlaceTest\Task\Controller;

use OnePlace\Task\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/task/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('task-api');
    }
}
